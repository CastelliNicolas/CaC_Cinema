import { enviarData } from "../shared_modules/apiFeedbackHandler";
...
<nav class="nav" id="nav">
  ...
  <div class="navLogin">
    ...
    <a href="user/perfil.html" id="profile-button" class="profile-button" style="display:none"><img class="profile-icon" src="/static/imagenes/user_icon.svg" alt="logo perfil" /> Perfil
    </a>
  </div>
</nav>`;
